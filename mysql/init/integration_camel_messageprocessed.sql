...
--
-- Table structure for table `camel_messageprocessed`
--
...
--
-- Dumping data for table `camel_messageprocessed`
--

LOCK TABLES `camel_messageprocessed` WRITE;
/*!40000 ALTER TABLE `camel_messageprocessed` DISABLE KEYS */;
/*!40000 ALTER TABLE `camel_messageprocessed` ENABLE KEYS */;
UNLOCK TABLES;
