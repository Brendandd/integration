...
--
-- Table structure for table `message_flow_step_filtered`
--

DROP TABLE IF EXISTS `message_flow_step_filtered`;
...
--
-- Dumping data for table `message_flow_step_filtered`
--

LOCK TABLES `message_flow_step_filtered` WRITE;
/*!40000 ALTER TABLE `message_flow_step_filtered` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_flow_step_filtered` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-04-19 18:38:03
