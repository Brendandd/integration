...
--
-- Table structure for table `message_flow_event`
--

DROP TABLE IF EXISTS `message_flow_event`;
...
--
-- Dumping data for table `message_flow_event`
--

LOCK TABLES `message_flow_event` WRITE;
/*!40000 ALTER TABLE `message_flow_event` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_flow_event` ENABLE KEYS */;
UNLOCK TABLES;
