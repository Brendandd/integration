...
public class OutboundRouteConnectorForwardingProcessor extends BaseMessageFlowProcessor<BaseOutboundRouteConnectorComponent> {
    ...
    public void process(Exchange exchange) throws Exception {              
        ...
        try {
            producerTemplate.sendBody("jms:topic:VirtualTopic." + component.getConnectorName(exchange), messageFlowDto.getId());
        } catch(Exception e) {
