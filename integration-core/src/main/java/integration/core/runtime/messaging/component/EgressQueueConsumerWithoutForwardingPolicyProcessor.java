...
/**
 * A common Camel processor which is called after a message flow id is read from the egress queue.  NO forwarding policy is applied and an event is written for forwarding.
 */
@Component
@Scope(value = ConfigurableBeanFactory.SCOPE_PROTOTYPE)
public class EgressQueueConsumerWithoutForwardingPolicyProcessor extends BaseMessageFlowProcessor<MessageConsumer> {
